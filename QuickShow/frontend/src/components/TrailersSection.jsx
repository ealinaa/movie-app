...
//             className="mx-auto max-w-full " width="90px" height ="540px"/>
//              {/* <ReactPlayer
...
console.log("ReactPlayerModule:", ReactPlayerModule);
  ...
  return (
    ...
    {dummyTrailers.map((trailer) =>(
        ...
        transition max-md:h-60 md:max-h-60 cursor-pointer" onClick={()=>setCurrentTrailer(trailer)}>
            ...
            md:w-8 w-5 h-5 md:h-12 transform -translate-x-1/2 -translate-y-1/2"
             />
            </div>
    ))}
